...
public class Product {
    ...
    //para encontrar erros nos testes com o app vou criar um marcação TAG
    ...
    // a coluna a baixo não tem na tabela ela será na memória
    private int mUnit;
...
// criar dois construtores da classe
    ...
    public Product(int id, String name, double price, int status, float rating, long image, int amountConsumption, int consumptionCycle, int unit) {    mId = id;
        mName = name;
        mPrice = price;
        mStatus = status;
        mRating = rating;
